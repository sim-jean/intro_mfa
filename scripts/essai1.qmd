...
-   Il faut donc créer un nouveau projet:
    ...
    -   Puis `New Directory > New Project` puis nommez le comme vous voulez
...
-   Pour commencer, vous allez aller sur la  page Github du cours ! `https://github.com/sim-jean/intro_mfa`
  - pour télécharger les scripts qui vont nous permettre de créer l'architecture, et mener les analyses.
